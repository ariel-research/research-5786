...
* ~[Streamlining Equal Shares (Kraiczy, Robinson, Elkind 2025)](https://www.ac.tuwien.ac.at/comsoc2025/comsoc2025-papers/96.pdf) - ליחיד~ - תפוס (יונתן גבאי).
...
* ~[An Adaptive and Verifiably Proportional Method for Participatory Budgeting (Kraiczy and Elkind, 2023)](https://arxiv.org/abs/2310.10215) - ליחיד.~ - תפוס (אלנתן לזר)
* ~[Maxmin Participatory Budgeting (Sreedurga, Bhardwaj and Narahari, 2022)](https://arxiv.org/abs/2204.13923) - ליחיד.~ - תפוס (נבו ביטון).
...
* ~[A Recommendation System for Participatory Budgeting (Leibiker and Talmon 2023)](https://optlearnmas23.github.io/files/p17.pdf) - לזוג. דרוש ידע בלמידת מכונה.~ - תפוס (רועי).
...
* [Algorithmic Aspects of Temporal Betweenness (Buss, Molter, Niedermeier, Rymar, 2020)](https://arxiv.org/abs/2006.08668) - ליחיד (אלגוריתם 1) או לזוג (גם אלגוריתם 2). קיים מימוש ב C++ אבל לא בפייתון.
תחום: centrality.
...
* [Computing Efficient Envy-Free Partial Allocations of Indivisible Goods (Bredereck, Kaczmarczyk, Luo and Sun, 2025)](https://www.ac.tuwien.ac.at/comsoc2025/comsoc2025-papers/75.pdf) -- ליחיד (משפטים 2,4) או לזוג (גם משפטים 5,6).
* [New Fairness Concepts for Allocating Indivisible Items (Caragiannis, Garg, Rathi, Sharma, Varricchio 2023)](https://arxiv.org/abs/2206.01710) - ליחיד.
* [Reducing Leximin Fairness to Utilitarian Optimization (Hartman et al, 2024)](https://arxiv.org/abs/2409.10395) - לזוג או ליחיד.
...
* [Ordinal Maximin Share Approximation for Goods (Hosseini et al, 2022)](https://www.jair.org/index.php/jair/article/view/13317) - ליחיד (אלגוריתם 3) או לזוג (גם אלגוריתם 2+1). - תפוס (קורן עבדוש).
* ~[Fair Division Under Cardinality Constraints (Barman and Biswas, 2018)](https://arxiv.org/abs/1804.09521) - ליחיד (אלגוריתמים 1, 2).~ - תפוס (ספיר דהן)
...
* ~[Your 2 is My 1, Your 3 is My 9: Handling Arbitrary Miscalibrations in Ratings (Wang and Shah 2018)](https://arxiv.org/abs/1806.05085) - ליחיד או לזוג. בשיתוף פעולה עם ליהי דראי מהנדסת תעשיה וניהול.~ תפוס (אביטל זר)
...
אפשר לשלב בספריה `opencv`.~ - תפוס (יוני ברוך, דני איסקוב, יבגני איוונוב) 
